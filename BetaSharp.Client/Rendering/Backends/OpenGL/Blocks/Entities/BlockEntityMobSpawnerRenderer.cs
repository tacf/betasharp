...
public class BlockEntityMobSpawnerRenderer : BlockEntitySpecialRenderer
{
    ...
    public void renderTileEntityMobSpawner(BlockEntityMobSpawner var1, double var2, double var4, double var6,
        float var8)
    {
        ...
        if (var9 != null)
        {
            ...
            GLManager.GL.Rotate((float)(var1.LastRotation + (var1.Rotation - var1.LastRotation) * (double)var8) * 10.0F,
                0.0F, 1.0F, 0.0F);
            ...
            tileEntityRenderer.EntityDispatcher.RenderEntityWithPosYaw(var9, 0.0D, 0.0D, 0.0D, 0.0F, var8);
        }
