...
public enum BufferUsage { Vertex, Index, Uniform, Staging }
public enum TextureUsage { Sampled, RenderTarget, DepthStencil, TransferSource, TransferDestination }
public enum TextureFormat { Rgba8Unorm, Bgra8Unorm, Depth24Stencil8 }
